...
Otteniamo $c_0$ ripetuto $n$ volte alla radice dell'albero. Vediamo nel dettaglio la complessità nelle varie
iterazioni.
\begin{itemize}
...
\begin{displaymath}
	\lim_{n \to +\infty} \frac{T^{MS}(n)}{T^{IS}(n)} = \lim_{n \to +\infty} \frac{a'n^2 + b'n + c'}{an \log_2n + b''n + c''} = 0
\end{displaymath}
